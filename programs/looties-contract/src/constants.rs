...
pub const MAX_TOKEN_IN_GAME: usize = 10;
pub const MAX_OPEN_IN_GAME: usize = 20;
pub const MAX_OPEN_TIME_IN_GAME: usize = 3;
pub const MAX_NFT_IN_BOX: usize = 150;
pub const MAX_REWARD_IN_BOX: usize = 10;
pub const MAX_CLAIMABLE_REWAED_IN_GAME: usize = 25;
...
pub const PLAYER_POOL_SEED: &str = "player-pool-2";
pub const PRIZE_POOL_SEED: &str = "prize-pool";
pub const SOL_VAULT_SEED: &str = "sol-vault";
pub const TEMP_BOX_SEED: &str = "temp-box-2";
